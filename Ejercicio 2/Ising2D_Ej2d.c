...
int main()
{
	...
	sprintf(filenameE, "Item_d_EvsJ_dim%i_Barridos%i_tau%i_B%.2lf.txt", dim, muestreos, tau, B);
	sprintf(filename, "Item_d_MvsJ_dim%i_Barridos%i_tau%i_B%.2lf.txt", dim, muestreos, tau, B);
